...
st.markdown("Real-time AQI monitoring and health scoring for Indian cities")
...
if "scored_df" in st.session_state:
    ...
    report_file = f"reports/AQI_Report_{datetime.now().strftime('%Y-%m-%d')}.xlsx"
    ...
    st.info("👆 Click the button above to fetch live AQI data for all cities!")